...
Officer: 1661810
CaseNum: 402-3-58070012-1661810
...
//    West: detSpeedX = -1 and detSpeedY = 0
	...
	///////////////////ADD YOUR CODE HERE///////////////////
    // go south
	if ((det.locationY < 135 && det.locationX > 758) || (det.locationX < 393 && det.locationY > 130) || (det.locationX > 696 && det.locationY > 192)){
		det.speedX = 0;
		det.speedY = 1;
	}
    // go west
    if((det.locationX > 393 && det.locationY > 135)){
        det.speedX = -1;
        det.speedY = 0;
    }
    // go east
    if((det.locationX < 697 && det.locationY > 192)){
        det.speedX = 1;
        det.speedY = 0;
    }
