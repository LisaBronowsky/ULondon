...
Officer: 1661810
CaseNum: 402-2-16584558-1661810
...
//    West: detSpeedX = -1 and detSpeedY = 0
    ...
    //east
	if (det.locationX < 261 || det.locationY == 445 || (det.locationX>500 && det.locationY<190) || (det.locationX>760 && det.locationY<75)){
		det.speedX = 1;
		det.speedY = 0;
	}
    
    //north
    if((det.locationX == 261 && det.locationY > 600) || (det.locationX > 508 && det.locationY>200) || (det.locationX>755 && det.locationY>75)){
        det.speedX = 0;
        det.speedY = -1;
    }
