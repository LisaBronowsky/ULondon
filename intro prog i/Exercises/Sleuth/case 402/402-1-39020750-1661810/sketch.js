...
Officer: 1661810
CaseNum: 402-1-39020750-1661810
...
//    West: detSpeedX = -1 and detSpeedY = 0
    ...
    //south
	if (currentRoad == "Meyers Way" || currentRoad == "Huffman Street"){
		det.speedX = 0;
		det.speedY = 1;
	}
    //east
    if(currentRoad == "Packard Avenue" || currentRoad == "Crowther Road" || currentRoad == "Dijkstra Street"){
        det.speedX = 1;
        det.speedY = 0;
    }
