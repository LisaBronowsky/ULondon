...
Officer: 1661810
CaseNum: 402-3-88181343-1661810
...
function draw()
{
	...
	///////////////////ADD YOUR CODE HERE///////////////////
    //go south
	if (det.locationY < 135 || det.locationX < 375 || det.locationX > 708 && det.locationY > 208){
		det.speedX = 0;
		det.speedY = 1;
	}
    
    //go west
    if(det.locationY > 135 && det.locationX > 375){
        det.speedX = -1;
        det.speedY = 0;
    }
    
    //go east
    if(det.locationY > 208 && det.locationX < 708){
        det.speedX = 1;
        det.speedY = 0;
    }
