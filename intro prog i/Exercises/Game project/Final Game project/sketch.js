/*
Game project final using sound
sound rights for background music go to bensound
*/
...
function preload(){
    ...
    canyonSound = loadSound('assets/canyonTrapped.mp3');
    canyonSound.setVolume(0.1);
    
    collectableSound = loadSound('assets/collectableReached.mp3');
    collectableSound.setVolume(0.1);
    
    enemySound = loadSound('assets/enemyContact.mp3');
    enemySound.setVolume(0.1);
    
    flagpoleSound = loadSound('assets/flagpoleReached.mp3');
...
function startGame(){
    ...
    clouds = [{x_pos: -700, y_pos: 100, size: 80},
              {x_pos: -500, y_pos: 70, size: 80},
              {x_pos: -400, y_pos: 100, size: 80},
              {x_pos: -300, y_pos: 50, size: 80},
    ...
    collectables = [{x_pos: -300, y_pos: floorPos_y-150, size: 50, isFound: false},
                    {x_pos: -175, y_pos: floorPos_y-150, size: 50, isFound: false},
                    {x_pos: -100, y_pos: floorPos_y-50, size: 50, isFound: false},
                    {x_pos: -50, y_pos: floorPos_y-150, size: 50, isFound: false},
